...
(function () {
  ...
  var SCENERY = {
    ...
    // 雪花用白色的 i-snow，樹葉是綠的會變成「夏天的樹站在雪地裡」，所以不放樹
    snow:   [['snow', 6, 6, 36], ['cloud', 76, 4, 48], ['snow', 30, 16, 24],
             ['snow', 88, 22, 32], ['cloud', 2, 30, 44], ['snow', 14, 40, 28],
             ['snow', 84, 46, 34], ['snow', 4, 56, 26], ['cloud', 62, 60, 42],
             ['snow', 20, 70, 30], ['snow', 88, 74, 24], ['snow', 8, 86, 32],
             ['snow', 50, 90, 22]],
    rainbow:[['cloud', 4, 6, 56], ['sun', 80, 4, 50], ['cloud', 76, 22, 44],
             ['star4', 30, 16, 24], ['cloud', 2, 36, 50], ['star4', 90, 40, 22],
             ['cloud', 84, 54, 46], ['star4', 8, 58, 26], ['cloud', 12, 70, 48],
             ['star4', 64, 76, 20], ['cloud', 80, 84, 42]],
