...
(function (global) {
  ...
  var DICT = {
    ...
    你: 'ㄋㄧˇ', 很: 'ㄏㄣˇ', 超: 'ㄔㄠ', 真: 'ㄓㄣ', 喔: '˙ㄛ',
    哇: 'ㄨㄚ', 級: 'ㄐㄧˊ', 強: 'ㄑㄧㄤˊ', 美: 'ㄇㄟˇ',
    只: 'ㄓˇ', 剩: 'ㄕㄥˋ', 最: 'ㄗㄨㄟˋ', 後: 'ㄏㄡˋ', 囉: '˙ㄌㄡ',
    ...
    // ── 數學挑戰 ──
    挑: 'ㄊㄧㄠ', 戰: 'ㄓㄢˋ', 答: 'ㄉㄚˊ', 對: 'ㄉㄨㄟˋ', 就: 'ㄐㄧㄡˋ',
    關: 'ㄍㄨㄢ', 題: 'ㄊㄧˊ', 練: 'ㄌㄧㄢˋ', 模: 'ㄇㄛˊ', 式: 'ㄕˋ',
    升: 'ㄕㄥ', 次: 'ㄘˋ', 案: 'ㄢˋ', 錯: 'ㄘㄨㄛˋ',
    過: 'ㄍㄨㄛˋ', 再: 'ㄗㄞˋ', 闖: 'ㄔㄨㄤˇ',
    前: 'ㄑㄧㄢˊ', 卡: 'ㄎㄚˇ', 進: 'ㄐㄧㄣˋ', 打: 'ㄉㄚˇ',
    金: 'ㄐㄧㄣ', 幣: 'ㄅㄧˋ',
    草: 'ㄘㄠˇ', 原: 'ㄩㄢˊ', 森: 'ㄙㄣ', 林: 'ㄌㄧㄣˊ',
    海: 'ㄏㄞˇ', 邊: 'ㄅㄧㄢ', 空: 'ㄎㄨㄥ', 宙: 'ㄓㄡˋ',
