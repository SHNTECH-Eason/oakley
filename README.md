...
**反饋必須有變化。** 一天八次、連續幾個月，一模一樣的動畫一個禮拜就變壁紙。所以稱讚語隨機、音高隨進度爬升、粒子數量隨進度加大，另外有約 14% 機率觸發金色的驚喜效果。

**反饋要累進。** 第八次應該比第一次盛大：粒子從 12 增到 26、音高往上爬五個半音、只剩一項時跳出「只剩最後一個囉！」並讓那張卡發光、全破放紙屑雨。

**語音朗讀（預設關閉）。** 五歲還不太識字，聽得懂比看得懂有用。開啟後會念「刷牙洗臉，完成！好棒喔！」，用 `speechSynthesis` 的 zh-TW 語音。預設關閉是因為合成語音有機械感，而且睡前那一項會出聲 —— 讓家長自己決定。開關在家長模式的「點數規則」裡。
